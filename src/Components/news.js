...
articles = [
  ...
  async componentDidMount(){
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=fc4524215a4d46da8f00d7a2bfb3d968&page=1&pagesize=${this.props.pageSize}`;
  ...
  handlePrevClick =async ()=>{
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=fc4524215a4d46da8f00d7a2bfb3d968&page=${this.state.page-1}&pagesize=${this.props.pageSize}`
    this.setState({loading:true})
